...
def main():
    ...
    # text = "After all we went through to pull him out of that mess <cry> I can't believe he was the traitor"
    # description = "seductively character, female voice in their 20s with american accent, slow pacing."
    # text = "Come to my place tonight, <giggle> and see what happens"
    # description = "flirty character, female voice in their 20s with american accent, slow pacing, high pitch"
    # text = "Ah, <sigh> stop it, <chuckle>"
    description = "villain character, male whispering voice in their 40s with british accent, very slow pacing, high pitch, raspy timbre, screaming tone at high intensity"
    text = "<whisper> Give me Harry Potter, <whisper> and your lives will be spared"
